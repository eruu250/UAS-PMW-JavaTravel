...
<div align="center">
 ...
 <span class="subHead">Ganti Kata Sandi<br /></span><br />
...
<tr><td class="labels">Kata Sandi Lama :</td><td><input type="password" name="old" size="25" class="fields" placeholder="Masukkan Kata Sandi Lama" required="required" /></td></tr>
...
<tr><td colspan="2" align="center"><input type="submit" value="Ganti Kata Sandi" class="fields" /></td></tr>
</table>
</form>
<br />
<br />
